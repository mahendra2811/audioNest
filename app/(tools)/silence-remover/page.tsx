...
export default function SilenceRemoverPage() {
  ...
  return (
    <ToolShell
      tool={tool}
      description="Uses ffmpeg silenceremove filter to automatically cut silent sections from your audio file."
    >
        ...
        <div className="flex flex-col gap-5">
          ...
          <div>
            <p className="text-sm font-medium mb-1 text-[var(--fg)] dark:text-[var(--fg)]">
              Threshold: <span className="font-mono">{threshold} dB</span>
            </p>
            <input
              type="range"
              min={-60}
          ...
          <div>
            <p className="text-sm font-medium mb-1 text-[var(--fg)] dark:text-[var(--fg)]">
              Min silence: <span className="font-mono">{minDuration}s</span>
            </p>
            <input
              type="range"
              min={0.1}
              ...
              className="w-full accent-indigo-500"
              aria-label="Min silence duration"
            />
          </div>
          <button
            type="button"
